...
<div id="container">
    <header id="header">
            ...
            <nav class="clear">
                ...
                <ul class="nav-list fl">
                    ...
                    <li class="nav-list-link fl">
                        <a href="SelModelServlet.do.do" class="nav-list-click">时代楷模</a>
                    ...
                    <li class="nav-list-link fl">
                        <a href="SelPolicyServlet.do" class="nav-list-click on">最新政策</a>
                        <ol class="nav-list-con">
                            <li class="nav-list-con-item">
    ...
    <article id="article">
        ...
        <div class="art-title">
            ...
            <img src="images/other/zxzc.jpg" alt="" width="1000" class="art-title-img">
        </div>
        ...
        <div class="content">
            <div class="art-cont">
                <div class="art-cont-title">
                    ...
                    <div class="art-content ">
                        <a href="">
                            <table cellpadding="5">
                                <%ArrayList<tm_info> list11= (ArrayList<tm_info>) request.getAttribute("Model11");
                                    System.out.println(list11.get(0).getTm_id());;
                                    for(int i=0;i<list11.size();i++)
                                    { %>
                                <tr>
                                    <td >
                                        <a href="SelServlet.do?id=<%=list11.get(i).getTm_id()%>"><p class="art-content-title"><%=list11.get(i).getTm_title()%>
                                        </p></a>
                                    </td>
                                </tr>
                                <%}%>
            ...
            <div class="art-cont">
                <div class="art-cont-title">
                    ...
                    <div class="art-content ">
                        <table cellpadding="5">
                            <%ArrayList<tm_info> list10= (ArrayList<tm_info>) request.getAttribute("Model10");
                                System.out.println(list10.get(0).getTm_id());;
                                for(int i=0;i<list10.size();i++)
                                { %>
                            <tr>
                                <td >
                                    <a href="SelServlet.do?tm_id=<%=list10.get(i).getTm_id()%>"><p class="art-content-title"><%=list10.get(i).getTm_title()%>
                                    </p></a>
                                </td>
                            </tr>
                            <%}%>
