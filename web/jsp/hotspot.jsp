...
<div id="container">
    ...
    <article id="article">
        ...
        <div class="art-title">
            ...
            <img src="images/other/djrd.jpg" alt="" width="1000" class="art-title-img">
        </div>
        <div class="content">
            ...
            <div class="art-cont">
                <div class="art-cont-title">
                    ...
                    <div class="art-content ">
                        <a href="">
                            <table cellpadding="5">
                                <%ArrayList<tm_info> list5= (ArrayList<tm_info>) request.getAttribute("Model5");
                                    for(int i=0;i<list5.size();i++)
                                    { %>
                                <tr>
                                    <td >
                                        <a href="SelServlet.do?tm_id=<%=list5.get(i).getTm_id()%>"><p class="art-content-title"><%=list5.get(i).getTm_title()%>
                                        </p></a>
                                    </td>
                                </tr>
                                <%}%>
            ...
            <div class="art-cont">
                <div class="art-cont-title">
                    ...
                    <div class="art-content ">
                        <table cellpadding="5">
                            <%ArrayList<tm_info> list6= (ArrayList<tm_info>) request.getAttribute("Model6");
                                for(int i=0;i<list6.size();i++)
                                { %>
                            <tr>
                                <td >
                                    <a href="SelServlet.do?tm_id=<%=list6.get(i).getTm_id()%>"><p class="art-content-title"><%=list6.get(i).getTm_title()%>
                                    </p></a>
                                </td>
                            </tr>
                            <%}%>
