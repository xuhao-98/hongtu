...
<div id="container">
        ...
        <nav class="clear">
            ...
            <ul class="nav-list fl">
                <li class="nav-list-link fl ">
                    <a href="jsp/index.jsp" class="nav-list-click">宏图首页</a>
                </li>
                <li class="nav-list-link fl">
                    <a href="SelModelServlet.do" class="nav-list-click on">时代楷模</a>
    ...
    <article id="article">
        ...
        <div class="art-title">
            ...
            <img src="images/other/sdkm.jpg" alt="" width="1000" class="art-title-img">
        </div>
        <div class="content">
            ...
            <div class="art-cont">
                <div class="art-cont-title">
                    ...
                    <div class="art-content ">
                        <a href="">
                            <table cellpadding="5">
                                <%ArrayList<tm_info> list1= (ArrayList<tm_info>) request.getAttribute("Model1");
                                    for(int i=0;i<list1.size();i++)
                                    { %>
                                <tr>
                                    <td >
                                        <a href="SelServlet.do?tm_id=<%=list1.get(i).getTm_id()%>"><p class="art-content-title"><%=list1.get(i).getTm_title()%>
                                        </p></a>
                                    </td>
                                </tr>
                                <%}%>
            ...
            <div class="art-cont">
                <div class="art-cont-title">
                    ...
                    <div class="art-content ">
                        <table cellpadding="5">
                            <%ArrayList<tm_info> list4= (ArrayList<tm_info>) request.getAttribute("Model4");
                                for(int i=0;i<list4.size();i++)
                                { %>
                            <tr>
                                <td >
                                    <a href="SelServlet.do?tm_id=<%=list4.get(i).getTm_id()%>"><p class="art-content-title"><%=list4.get(i).getTm_title()%>
                                    </p></a>
                                </td>
                            </tr>
                            <%}%>
        ...
        <div class="content">
            <div class="art-cont">
                <div class="art-cont-title">
                    ...
                    <div class="art-content ">
                        <table cellpadding="5">
                            <%ArrayList<tm_info> list3= (ArrayList<tm_info>) request.getAttribute("Model3");
                                for(int i=0;i<list3.size();i++)
                                { %>
                            <tr>
                                <td >
                                    <a href="SelServlet.do?tm_id=<%=list3.get(i).getTm_id()%>"><p class="art-content-title"><%=list3.get(i).getTm_title()%>
                                    </p></a>
                                </td>
                            </tr>
                            <%}%>
            ...
            <div class="art-cont">
                <div class="art-cont-title">
                    ...
                    <div class="art-content ">
                        <table cellpadding="5">
                            <%ArrayList<tm_info> list2= (ArrayList<tm_info>) request.getAttribute("Model2");
                                for(int i=0;i<list2.size();i++)
                                { %>
                            <tr>
                                <td >
                                    <a href="SelServlet.do?tm_id=<%=list2.get(i).getTm_id()%>"><p class="art-content-title"><%=list2.get(i).getTm_title()%>
                                    </p></a>
                                </td>
                            </tr>
                            <%}%>
