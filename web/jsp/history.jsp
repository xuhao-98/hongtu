...
<div id="container">
    <header id="header">
        ...
        <nav class="clear">
            ...
            <ul class="nav-list fl">
                ...
                <li class="nav-list-link fl">
                    <a href="SelHistoryServlet.do" class="nav-list-click on">铭记历史</a>
                </li>
                <li class="nav-list-link fl">
    ...
    <article id="article">
        ...
        <div class="art-title">
            <p class="art-title-top">铭记历史</p>
            <img src="images/other/mjls.jpg" alt="" width="1000" class="art-title-img">
        </div>
        ...
        <div class="content">
            <div class="art-cont">
                <div class="art-cont-title">
                    ...
                    <div class="art-content ">
                        <a href="">
                            <table cellpadding="5">
                                <%ArrayList<tm_info> list8= (ArrayList<tm_info>) request.getAttribute("Model8");
                                    for(int i=0;i<list8.size();i++)
                                    { %>
                                <tr>
                                    <td >
                                        <a href="SelServlet.do?tm_id=<%=list8.get(i).getTm_id()%>"><p class="art-content-title"><%=list8.get(i).getTm_title()%>
                                        </p></a>
                                    </td>
                                </tr>
                                <%}%>
            ...
            <div class="art-cont">
                <div class="art-cont-title">
                    ...
                    <div class="art-content ">
                        <table cellpadding="5">
                            <%ArrayList<tm_info> list7= (ArrayList<tm_info>) request.getAttribute("Model7");
                                for(int i=0;i<list7.size();i++)
                                { %>
                            <tr>
                                <td >
                                    <a href="SelServlet.do?tm_id=<%=list7.get(i).getTm_id()%>"><p class="art-content-title"><%=list7.get(i).getTm_title()%>
                                    </p></a>
                                </td>
                            </tr>
                            <%}%>
